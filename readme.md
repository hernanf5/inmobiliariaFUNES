...
**4. Configurar el Salt para el hasheo de contraseñas**
 
Además de la cadena de conexión, `appsettings.json` necesita una clave `Salt`, usada para hashear las contraseñas de los usuarios. Para que los usuarios de prueba (ver sección de abajo) funcionen tal cual, agregá exactamente:
 
```json
"Salt": "hernan-funes-2026inmobiliaria"
```
...
La base incluye dos usuarios precargados para poder loguearse apenas se levanta el proyecto:
 
| Rol | Email | Contraseña |
|---|---|---|
| Administrador | admin@inmobiliaria.com | Admin1234 |
| Empleado | empleado@inmobiliaria.com | Empleado1234 |
 
> Estas credenciales solo funcionan si `appsettings.json` tiene configurado el `Salt` indicado en el paso anterior — las contraseñas están hasheadas con ese valor exacto. Si se cambia el `Salt`, hay que volver a dar de alta los usuarios (o recalcular los hashes).
